# Generated by Django 5.0.2 on 2024-03-06 00:04
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(default='Goods', max_length=100)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('price', models.DecimalField(decimal_places=2, default='5.99', max_digits=9999999999)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('price', models.DecimalField(decimal_places=2, default='5.99', max_digits=9999999999)),
                ('total', models.DecimalField(decimal_places=2, default='5.99', max_digits=9999999999)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(default='Cooler', max_length=100)),
                ...
                ('price', models.DecimalField(decimal_places=2, default='5.99', max_digits=9999999999)),
                ('old_price', models.DecimalField(decimal_places=2, default='9.99', max_digits=9999999999)),
                ('specifications', models.TextField(blank=True, null=True)),
                ('type', models.CharField(blank=True, default='Output Devices', max_length=100, null=True)),
                ('stock_count', models.IntegerField(blank=True, default='10', null=True)),
                ('life', models.CharField(blank=True, default='3 - 8 Years', max_length=100, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(default='PcStore', max_length=100)),
                ...
                ('description', models.TextField(blank=True, default='I sell many products.', null=True)),
                ('address', models.CharField(default='No 12, Jalan Sung 5, 68100 Batu Caves.', max_length=100)),
                ('contact', models.CharField(default='+012 (456) 789', max_length=100)),
                ...
                ('warranty_period', models.CharField(default='2', max_length=100)),
